...
describe('Article ', () => {
    ...
    it('Register POST /users', (done) => {    
        ...
        .end((err, res) => {
            ...
            expect(res.body.user).to.ownProperty('_id')
                .to.be.a('string');
            expect(res.body).haveOwnProperty('user').to.be.an('object').contains({
    ...
    it('Login', (done) => {
        ...
        .end((err, res) => {
            ...
            expect(res.body).to.ownProperty('apptoken').to.be.a('string');
    ...
    it('Get /articles', (done) => {
        ...
        .end((err, res) => {
            expect(res).to.have.status(200);
            expect(res.body).to.ownProperty('articles').to.be.an('array');
            done();
        })
    });
    ...
    it('Put /articles', (done) => {
        ...
        .end((err, res) => {
            expect(res).to.have.status(200);            
            expect(res.body).to.ownProperty('message').to.be.a('string').eql('Article Updated');
            done();
        })
    });
    ...
    it('Delete /articles', (done) => {
        ...
        .end((err, res) => {
            expect(res).to.have.status(200);
            expect(res.body.message).to.be.a('string').eql('Article deleted');
            done();
        })
    });
